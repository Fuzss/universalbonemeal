...
public class UniversalBoneMeal {
    ...
    public static void onCommonSetup(final FMLCommonSetupEvent evt) {
        ...
        BonemealHandler.registerBehavior(Blocks.LILY_PAD, () -> new SimpleSpreadBehavior(SimpleStateProvider.simple(Blocks.LILY_PAD)), () -> CONFIG.server().allowLilyPad);
        BonemealHandler.registerBehavior(Blocks.DEAD_BUSH, () -> new SimpleSpreadBehavior(SimpleStateProvider.simple(Blocks.DEAD_BUSH)), () -> CONFIG.server().allowDeadBush);
        BonemealHandler.registerBehavior(Blocks.ALLIUM, () -> new SimpleSpreadBehavior(SimpleStateProvider.simple(Blocks.ALLIUM)), () -> CONFIG.server().allowFlowers);
